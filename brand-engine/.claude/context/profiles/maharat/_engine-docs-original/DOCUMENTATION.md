...
numerals only (0 to 9), Arabic-first with Gulf-familiar Modern Standard Arabic in the Thmanyah
...
The core context files: `00-start-here.md`, `01-company-brief.md`, `02-objective-and-design.md`,
...
the workshop. The `context/instructors/` subtree holds the instructor catalog and per-instructor
...
The registry: `context/instructors/_CATALOG.md`, one row per instructor, with a public-status
...
Arabic-first voice with hard mechanical rules; the success_metric fixed before measurement; a
