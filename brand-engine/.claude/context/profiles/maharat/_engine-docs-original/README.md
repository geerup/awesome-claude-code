...
Western numerals only, Arabic-first, empowering framing, never imply certificate accreditation.
...
- Email subsystem: the slotted live-component standard (`context/email-design-system.md` plus
