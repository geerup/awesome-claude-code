# Email 7-step: Cedric Haddad, Teaches Personal Styling (nurture-to-subscribe, slotted build)
...
(`skills/instructor-marketing/cedric-haddad/` SKILL.md, voice.md, masterclass-pages.md) plus
...
- `src`: `https://dt92b02v6m7lx.cloudfront.net/CH_CLASSCOVER_DESKTOP_01_LEFTGRADIENT.webp`
...
- Every line of copy is a LIVE HTML text slot (`data-slot="copy"`) bound to a stable
  `data-copy-id` (`email-cedric-haddad-<id>-<role>-<lang>`; eyebrow and footer sender are
...
```
python3 .claude/scripts/email_render.py .claude/outputs/2026-06-cedric-haddad-styling/email-7step/cedric-haddad/spec.json
...
- celebrity client names or any specific star Cedric has styled
- catalog status pending final confirmation despite press and site evidence
- any price, subscription plan, or monthly figure (brief is silent)
- any lesson count, chapter count, or class duration (page does not enumerate)
- any award, brand-line, or specific career figure not on the page or in voice.md
- any guaranteed social or career outcome
- any testimonial or named student result
- accreditation of the completion certificate
...
3. Catalog status: cedric-haddad is unconfirmed in context/instructors/_CATALOG.md. Every instructor email is an INTERNAL DRAFT blocked on catalog status, the same status as the existing Bassam build. Nothing sends.
