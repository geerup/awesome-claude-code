...
# longform-001, article (A19)

Pillar: governed agentic systems. Audience: CMOs. Target: newsletter issue 1, cross-posted to LinkedIn articles.

---

# The gate is the product

Marketing teams are about to be sold a thousand agentic stacks. Most will be judged on the wrong number: how much they produce. Here is the number that matters instead: how much they refuse to ship without a human yes.
...
## Why an unlaunched engine is worth writing about
...
First, where is the gate, in the code, and can anything route around it. Second, how do skills fail: silently, or against eval cases that block use. Third, who fixes a flagged output: the reviewer, or the writer, with a second review confirming. The wrong answer to any of these is fluency in a demo and a mess in production.

The campaigns were never the point. The system that runs them is.
