...
2. Case study: the Maharat Marketing Engine (governed agentic systems lane).
3. Case study: Canonical organic growth (Arabic-first MENA lane pairs with this after the case import).

## Banner brief
Positioning sentence set in type over a systems schematic motif, dark ground, no stock imagery, no photo of dashboards. Name in both registers: Ahmed (San) El Sanhoury.
